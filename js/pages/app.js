// ============================================================
// SISCOF v3 — App shell + navegación
// Incluye: indicador sync offline, menú historial, maestras, usuarios
// ============================================================
  ...
  document.body.innerHTML = `
    <nav class="navbar">
      ...
      <div class="navbar-links">
        ...
        <button class="nav-btn" id="nav-historial" onclick="navegar('historial')">
          ≡ Historial
        </button>
        ${APP.esAdmin || APP.esComisaria ? `
        <button class="nav-btn" id="nav-maestras" onclick="navegar('maestras')">
          ◻ Puntos
        </button>` : ''}
        ${APP.esAdmin ? `
        <button class="nav-btn" id="nav-usuarios" onclick="navegar('usuarios')">
          ◎ Usuarios
        </button>
      ...
      <div class="navbar-user">
        ...
        <span id="sync-badge" class="sync-badge sync-ok" onclick="intentarSync()" title="Estado de sincronización">
...
async function navegar(pantalla) {
  ...
  const pantallas = ['dashboard','registro','historial','maestras','usuarios','admin']
  pantallas.forEach(p => {
